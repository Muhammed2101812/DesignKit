          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="rounded-lg border p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>
                  <a href="/tools/background-remover" className="hover:text-primary transition-colors">
                    → Background Remover
                  </a>
                </li>
                <li>
                  <a href="/tools/image-upscaler" className="hover:text-primary transition-colors">
                    → Image Upscaler
                  </a>
                </li>
              </ul>
